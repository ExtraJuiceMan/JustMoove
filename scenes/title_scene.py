...
class TitleScene(SceneBase):
    ...
    def render(self, screen: pygame.Surface):
        ...
        scale_ratio = screen.get_size()[0] / background_image.get_size()[0]
        background_image = pygame.transform.smoothscale(background_image, (background_image.get_size()[0] * scale_ratio, background_image.get_size()[1] * scale_ratio))
